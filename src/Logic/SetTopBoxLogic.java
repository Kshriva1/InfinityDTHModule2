...
public class SetTopBoxLogic {
	...
	// Add new Set Top Box
	public  boolean addSetTopBox(String type, int length, int breadth, int width, double price,
		...
		try {
			...
			for (int i = 0; i < features.size(); i++) {
				...
				// Table
				addFeature = "INSERT INTO SetTopBox_Feature VALUES (" + boxId.getInt(1) + "," + featureId.getInt(1) + ")";
